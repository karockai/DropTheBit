...
function UserName() {
    ...
    const userName = '김용기'
    return(
        <div className={classes.root}>{userName+'님의 계좌 잔고'}</div>
    );
}
  ...
  return (
      ...
      <Table>
          <TableRow>
            ...
            <TableCell style={{fontSize: 30}} align="right">{currTotal}</TableCell>
          </TableRow>
          <TableRow>
            <TableCell>작년대비</TableCell>
            <TableCell align="right">{'+'+profitAmount+'(+'+`${(profitRate * 100).toFixed(0)} %)`}</TableCell>
      ...
      <Table className={classes.table} aria-label="customized table">
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="right">매입금액</StyledTableCell>
            <StyledTableCell align="right">주식수</StyledTableCell>
            <StyledTableCell align="right">현재금액</StyledTableCell>
